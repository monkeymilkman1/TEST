...
# Lab 03 
# Lab Section: 10
# Sources: CHATGPT for understanding of different commands, and how to accomplish certain tasks with them.
...
sum_max=0
sum_min=0
for maxs in max_temps:
    n=n+1 #Calculate total number of of items
    position=position+1 #Calculate current position of loop
    sum_max=sum_max+maxs #Find Sum of Maximum Temperatures
    sum_min=sum_min+min_temps[position] #Find Sum of Minimum Temperatures
print("Average Maximum Temperature: ",(sum_max/n)) #Display calculated averages from loop
print("Average Minimum Temperature: ",sum_min/n) #Display calculated averages from loop

import statistics #This is to confirm that my calculated averages are correct
max_mean=statistics.mean(max_temps)
min_mean=statistics.mean(min_temps)
print("Max Avg Found by .mean(max_temps): ",max_mean) 
print("Min Avg Found by .mean(min_temps): ",min_mean)
#Running this function shows my calcuated averages and .mean() calcuated averages are equivalent.


# For the next part, determine the highest and lowest recorded temperatures.
# HINT: You can find this information without using any logic or looping.

abs_min=min(min_temps) #Find Max
abs_max=max(max_temps) #Find Min
print(f"The Absolute Max Temperature is {abs_max}, and the Absolute Minimum Temperature is{abs_min}.")
#Prints the Absolute Max and Minimum Temperatures found with max() and min().
